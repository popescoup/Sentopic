/**
 * Parameters Step Component
 * Step 2: Collection parameters configuration
 */
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <select
            value={formData.parameters.sort_method}
          ...
          <p className="mt-1 text-sm text-text-tertiary">
            {formData.parameters.sort_method === 'hot' && 'Active discussions with high engagement'}
            {formData.parameters.sort_method === 'new' && 'Most recently posted content'}
            {formData.parameters.sort_method === 'rising' && 'Posts gaining popularity quickly'}
            {formData.parameters.sort_method === 'top' && 'Highest scoring posts in time period'}
            {formData.parameters.sort_method === 'controversial' && 'Posts with mixed reactions'}
          </p>
        </div>

        {/* Time Period (conditional) */}
        {['top', 'controversial'].includes(formData.parameters.sort_method) && (
          <div className="mx-1">
            <label className="block font-medium text-text-primary mb-2">
              Time Period *
            </label>
            <select
              value={formData.parameters.time_period || ''}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="mx-1">
            <Input
              ...
              min="1"
              max="1000"
              value={formData.parameters.posts_count}
              onChange={(e) => {
          ...
          <div className="mx-1">
            <Input
              ...
              min="0"
              max="100"
              value={formData.parameters.root_comments}
              onChange={(e) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="mx-1">
            <Input
              ...
              min="0"
              max="50"
              value={formData.parameters.replies_per_root}
              onChange={(e) => {
                const value = e.target.value === '' ? '' : parseInt(e.target.value) || 0;
          ...
          <div className="mx-1">
            <Input
              ...
              type="number"
              min="0"
              value={formData.parameters.min_upvotes}
              onChange={(e) => {
                const value = e.target.value === '' ? '' : parseInt(e.target.value) || 0;
