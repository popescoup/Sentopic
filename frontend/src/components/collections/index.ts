/**
 * Collections Components Export Index
 * Clean exports for all collection-related components
 */

export { default as CollectionCreationModal } from './CollectionCreationModal';
